...
/** Necessary Constants **/
defined( 'ULC_VERSION' ) or define( 'ULC_VERSION', '1.1.2' ); //plugin version
...
if(!class_exists('Ultra_Companion')) :
	...
	class Ultra_Companion {
		...
		if ( current_user_can( 'install_plugins' ) ){
		    ...
		    if ( ! get_user_meta($user_id, 'wpop_ignore_notice222') && !defined('WPOP_PRO') ) {
            ?>
            <div class="notice wpop_admin_notice wpop_admin_notice_1" >
            	...
            	<div class="wpop_notice_right_content">
                    <div class="wpop_notice_content">
                    	<a class="wpop_no_thanks" href="<?php echo admin_url('/?wpop_nag_ignore=0');?>">not interested</a>
                    </div>
                    <div class="wpop_notice_after_content"></div>
                </div>
                <div class="wpop_notice_content_wrap">
                    <div class="wpop_notice_content">
                    	<?php if(get_template() == 'ultra-seven'|| get_template() == 'ultra-lite'){?>
		     			...
		     			<?php } elseif(get_template() == 'arrival' || get_template() == 'arrival-me'){?>	
